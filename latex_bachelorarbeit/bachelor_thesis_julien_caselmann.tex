...
\subsection{Noisy voter model}%TODO: is this model also influenced by liggett? read it again
...
. A lot of individuals do not have an immutable opinion on vaccines and tend to follow trends and make a new decision every year, whether they're going to vaccinate or not %TODO: quelle dafür
...
Fragen von gestern dazu klären und dann entspynnt aufschreiben.
\subsection{Sano model}
TODO: Recherche und entscheiden, ob relevant %TODO: do more research on sano model, so I know whether imma use it or nah
\section{My Model}
\section{Discussion}
