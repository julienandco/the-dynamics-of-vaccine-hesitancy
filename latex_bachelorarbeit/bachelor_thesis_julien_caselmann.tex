...
\begin{figure}%TODO: do i need to use it? and can i? (is BA private use?)
	\centering
	\caption{Immunization against meningococcus C - Implementation Analysis in 2013 of the \ac{STIKO} recommendations from 2009 to 2014 \cite{LamegoGreinerMGoffrierB2016}}
