...
%TODO heute: takens-bogdanov rallen
...
\begin{proof}
	...
	By rewriting drift and noise term with $n_i = \frac{N_i}{N}, \theta_i = 1- \frac{\Theta_i}{N}$, $h = \frac{1}{N}, i= \frac{I}{N}, a = \frac{A}{N}$ and neglecting terms of $\mathcal{O}(h^2)$ we find (using maxima %TODO: cite maxima
	):
