...
%TODO last: many weird sources, fix them. all last names and titles pls NOT capslock. all titles in same font (italic or normal, but not mixed). get maxima citation from maxima FAQ page. adjust KBV overfull link. mullers paper has tellier aurelien and not tellier A. cite xppaut just as maxima
