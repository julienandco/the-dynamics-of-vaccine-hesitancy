...
\end{align*}
\end{proof}
This model looks very promising and almost suits our needs, but still lacks one aspect: reinforcement. This means that individuals, whose life is predominantly taking place in a filter bubble, are less likely to interact with a group of individuals who is representative for the population. Their social contacts will rather all be inside the filter bubble, thus all be like-minded and lead to the opinion to never change or even to enhance.%TODO: quelle für filter bubbles make more radikal?
Research has concluded that most of the election successes of extreme right or left wing parties in Europe, as well as Trump's election for president in 2016 had a lot of reinforcement involved. In Germany for instance, the right-wing \ac{AfD} has extreme support in the german federal states that belong to the old eastern Germany and Trump has a lot of homies in Texas.%TODO: andere quelle als müller finden, da noch nicht publiziert -> müller deswegen fragen
...
\begin{model}[\textbf{Zealot model for two parties with reinforcement}]\label{model:zealot_reinforcement}%TODO: source for this, since it ain't mine
