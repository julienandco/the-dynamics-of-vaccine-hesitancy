...
%TODO last: many weird sources, fix them. all last names and titles pls NOT capslock. all titles in same font (italic or normal, but not mixed). get maxima citation from maxima FAQ page. adjust KBV overfull link. Muller manuskript has his name completely printed? prolly citavi fail
...
%TODO: alle def-theor überschriften auch in groß
...
%TODO: reformulate this intro, since it is copy-paste from muellers paper
